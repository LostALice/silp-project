...
# useless
# costumer need 
- they need a program which can help them choose what to eat and how to eat healthily.
# if個客想破戒
- to rebuild their diet plan 

# 對商店嘅benefit 
- 有營食肆
    - help them to promote <> get their menu for db
- 一般食肆
    - promotion
    - comment system 
...
- user 
    - 影餐單比我地 (每日簽到) 分數換好野
- shop/restaurant
    - 影餐單比我地 update menu -> promotion
    
# 營養成份
- 影餐單
    - 分析with data in db (e.g. 干炒牛河 牛河,炒=keyword 牛肉的營養, 河粉的營養等 avg)
- 店家提供
    - 以店家提供的data 分別對比同類型店家
...
- _*W*_ (Weaknesses):
    ...
    - 餐廳資料不能在短時間內建立
- _*O*_ (Opportunities ):
    - 市場上有的健康餐單都以獨立為主，而沒有可以提供整合的平台
    - 正值covid-19 時期，市民會有更多情況選擇利用線上平台購買三餐
    - 因為多數年輕一代(18-30)是更會使用網絡平台購買三餐，而這個年齡層比其他年齡層更會關切自己的身體健康
- _*T*_ (Threats):
    - 其他的網上餐廳指南如openrice 在香港已經為人所識，用戶或未有意願轉移到其他平台
    - 市民會選擇營養師去獲得單對單的健康資訊
...
- ### 結構
    - #### 分工
        - 發起人
            1. 確保完成計畫的最終目標
            1. 進行及管理組內有效的溝通工作
            1. 進行計畫的風險管理，預防，甚至是減輕風險
            1. 給予適當的援助或資源，並鼓勵組員增加團隊士氣
...
- #### 理論
    - 1st stage
        ...
        2. co-work with 食肆  
            - find 有營食肆 -> 餐單 get daze 
            - promote <> menu
            - promote ourself to other 一般食肆 -> show their difference to other alternative
    
    - 2 nd stage 
        1. promote to public
            - ad on bus/mtr
            - share app to fds to get reward 
            - membership release
        2. need user upload restaurant menu
            - us    : update our db
            - user  : get reward from upload restaurant menu
    
    - 3 rd stage 
        1. analysis restaurant food 
            - to get the detail 營養成份
        2. use data to promote what customers want to restaurant
...
- #### app detail 
    ...
    2. menu system 
        - provide the approximate nutrients
        - show different food nutrients, let people compare
